...
{
    /// <summary>
    /// sdk_core auth add-final-access-right [userId=\"...\"] path=\"...\" rights=\"...\" apiKey=\"...\"
    /// sdk_core auth add-final-access-right [userId=\"...\"] path=\"...\" rights=\"...\" email=\"...\" passwordMd5=\"...\"
    /// sdk_core auth add-final-access-right [userId=\"...\"] path=\"...\" rights=\"...\" name=\"...\" passwordMd5=\"...\"
    ///     A single path=\"...\" rights=\"...\" pair must be provided.
    /// </summary>
    public class Auth_AddFinalAccessRight : Command_0_1
    {
        public Auth_AddFinalAccessRight(Arguments _Arguments)
...

        {
            if (bParseable)
            {
                ...
                CreatedRequest = new ApiHttpRequest(BaseApiUrl, "/auth/users/" + UserID + "/access_methods/" + AuthMethod + "/access_rights")
                    .Put(new JArray()
                    { 
                        new JObject()
                        {
        ...
        public override List<(int, string)> GetHelpLines()
        {
            ...
            {
                (2, "auth add-final-access-right [userId=\"...\"] path=\"...\" rights=\"...\" apiKey=\"...\""),
                (2, "auth add-final-access-right [userId=\"...\"] path=\"...\" rights=\"...\" email=\"...\" passwordMd5=\"...\""),
                (2, "auth add-final-access-right [userId=\"...\"] path=\"...\" rights=\"...\" name=\"...\" passwordMd5=\"...\""),

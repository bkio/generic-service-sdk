...
{
    /// <summary>
    /// sdk_core auth get-final-access-rights [userId=\"...\"] apiKey=\"...\"
    /// sdk_core auth get-final-access-rights [userId=\"...\"] email=\"...\" passwordMd5=\"...\"
    /// sdk_core auth get-final-access-rights [userId=\"...\"] name=\"...\" passwordMd5=\"...\"
    /// </summary>
    public class Auth_GetFinalAccessRights : Command_0_1
    {
        public Auth_GetFinalAccessRights(Arguments _Arguments)
...

        {
            if (bParseable)
            {
                ...
                CreatedRequest = new ApiHttpRequest(BaseApiUrl, "/auth/users/" + UserID + "/access_methods/" + AuthMethod + "/access_rights").Get();
            }
        }

        public override string GetCommandName()
        {
            return "get-final-access-rights";
        }
        ...
        public override List<(int, string)> GetHelpLines()
        {
            ...
            {
                (2, "auth get-final-access-rights [userId=\"...\"] apiKey=\"...\""),
                (2, "auth get-final-access-rights [userId=\"...\"] email=\"...\" passwordMd5=\"...\""),
                (2, "auth get-final-access-rights [userId=\"...\"] name=\"...\" passwordMd5=\"...\""),
                (0, "\n")
            };
        }
    }

...
namespace SDK.Versions.V_0_1
{
    ...
    {
        public File_CreateVersion(Arguments _Arguments)
...

        {
            if (bParseable)
            {
                ...
                CreatedRequest = new ApiHttpRequest(BaseApiUrl, "/file/models/" + ModelID + "/revisions/" + RevisionIndex + "/versions").Put(Request);
            }
        }
        ...
        public override List<(int, string)> GetHelpLines()
        {
            ...
            {
                (2, "file create-version modelId=\"...\" revisionIndex=\"...\" name=\"...\" [commentsPath=\"...\"]"),
                (0, "\n")
            };
        }
    }

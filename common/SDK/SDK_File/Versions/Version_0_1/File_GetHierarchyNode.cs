    ...
    public class File_GetHierarchyNode : Command_0_1
    {
...

        {
            if (bParseable)
            {
                ...
                CreatedRequest = new ApiHttpRequest(BaseApiUrl, "/file/models/" + ModelID + "/revisions/" + RevisionIndex + "/versions/" + VersionIndex + "/hierarchy/nodes/" + NodeID).Get();
            }
        }
        ...
        public override List<(int, string)> GetHelpLines()
        {
            ...
            {
                (2, "file get-hierarchy-node modelId=\"...\" revisionIndex=\"...\" versionIndex=\"...\" nodeId=\"...\""),
                (0, "\n")
            };
        }
    }
